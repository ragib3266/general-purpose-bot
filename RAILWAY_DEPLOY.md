...
- **Bot online but not responding?** → Make sure MESSAGE CONTENT INTENT is enabled in Discord Developer Portal
- **Bot offline?** → Check Railway logs for errors, verify TOKEN is set correctly
- **Still having issues?** → Check that your bot is invited to your server with proper permissions
